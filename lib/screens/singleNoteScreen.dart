        ...
        children: [
          Row(
            children: [
              SizedBox(width: 25,),
              Container(
                child: Icon(Icons.add,color: Colors.white60,size: 20,),
              ...
              SizedBox(width: 15,),
              Icon(Icons.color_lens_outlined,color: Colors.white60,size: 25,),
              SizedBox(width: 15,),
              Icon(Icons.legend_toggle,color: Colors.white60,size: 25,),
            ],
          ),
          Row(
            children: [
              ...
              SizedBox(width: 10,),
              Icon(Icons.more_vert,color: Colors.white60,size: 25,),
              SizedBox(width: 5,),
            ],
          ),
        ],
